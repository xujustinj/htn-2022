    ...
    return (
        ...
        <div className="p-4 ml-6">
            ...
            <ul class="mt-5 flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
                ...
                <li class="mr-2">
                    <a href="/voice" aria-current="page" class="flex p-4 text-blue-600 bg-gray-100 rounded-t-lg active dark:bg-gray-800 dark:text-blue-500" >Voice</a>
                </li>
                <li class="mr-2">
