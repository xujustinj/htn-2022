...
export  function VideoCreation() {
  return (
    ...
    <li class="mr-2">
        <a href="#" aria-current="page" class="flex p-4 text-blue-600 bg-gray-100 rounded-t-lg active dark:bg-gray-800 dark:text-blue-500">Length</a>
    </li> 
    <li class="mr-2">
        <a href="#" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300">Formality</a>
    </li>
    <li class="mr-2">
...
<div id="info-popup" tabindex="-1" class=" mt-60 ml-6 verflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
